...
import { ArrowRight, Mail, Phone, Menu, X } from "lucide-react";
...
const Header = () => {
  ...
  return (
    <>
      <div className="container hidden lg:flex items-center py-3 my-6 gap-3 justify-between bg-light-gray rounded-lg px-6">
        <div className="flex items-center gap-4">
          <Image src={images.insta} width={18} height={18} alt="Instagram" />
          <Image src={images.fb} width={18} height={18} alt="Facebook" />
          <Image src={images.whatsapp} width={18} height={18} alt="WhatsApp" />
          <Image src={images.youtube} width={18} height={18} alt="YouTube" />
        </div>

        <div className="hidden md:flex items-center gap-6">
          <p className="flex items-center gap-2 text-sm">
            <Mail size={18} />
            <span className="font-light">info@alfaexchange.com</span>
          </p>

          <p className="flex items-center gap-2 text-sm">
            <Phone size={18} />
            <span className="font-light">+971 4 2340777</span>
          </p>
        </div>
      </div>

      <header className="container px-6 flex items-center justify-between my-6">
        <Link href={"/"}>
          <Image
            src={images.logo}
            width={120}
            ...
            <MenubarMenu>
              ...
              <MenubarContent>
                ...
                >
                  ...
                  <MenubarRadioItem value="ar">Arabic</MenubarRadioItem>
                </MenubarRadioGroup>
              </MenubarContent>
            </MenubarMenu>
          </Menubar>
